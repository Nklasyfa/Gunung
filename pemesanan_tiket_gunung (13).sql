...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Des 2025 pada 01.48
...
--
-- Dumping data untuk tabel `anggota_pemesanan`
--

INSERT INTO `anggota_pemesanan` (`anggota_id`, `pemesanan_id`, `user_id_anggota`) VALUES
(20, 22, 11),
(21, 23, 11);
...
(1, 'Gunung Lawu', 'Jawa Timur', -7.62600000, 111.19700000, 3265, 'Gunung populer dengan jalur Cemoro Sewu dan Cemoro Kandang', 'Gunung Lawu dikenal memiliki nilai sejarah tinggi, dengan banyak situs peninggalan Majapahit di lerengnya.', '2 hari 1 malam (via Cemoro Sewu)', 200, 'dibuka', '360_F_180045614_wUikfPv1VhpukGYtUBDfA2sGggXXJmQ5_1764551392.jpg', 494, 0, 1, 2),
...
(1, 1, 'Cemoro Sewu', 'Jalur favorit', '8 jam', NULL, 'sedang', 0, NULL, 1, 10, 35000.00),
(2, 1, 'Cemoro Kandang', 'Jalur lebih panjang', '10 jam', NULL, 'sedang', 0, NULL, 1, 10, 50000.00),
(3, 3, 'Thekelan', 'Jalur resmi Merbabu', '9 jam', 'IMG_20230304_072026_1764635127.jpg', 'sedang', 0, NULL, 1, 0, NULL),
(12, 4, 'Banaran', 'qqqqq', '9 jam', NULL, 'sulit', 0, NULL, 1, 200, 25000.00);
...
--
-- Dumping data untuk tabel `kuota_bulanan_user`
--

INSERT INTO `kuota_bulanan_user` (`kuota_bulanan_user_id`, `user_id`, `tahun_bulan`, `kuota_tersisa`, `kuota_awal`) VALUES
(1, 11, '2025-12', 23, 10);
...
(18, 22, '', 25000, '2025-12-12 20:52:06', 'berhasil'),
(19, 23, '', 35000, '2025-12-13 07:45:44', 'berhasil');
...
CREATE TABLE `pemesanan` (
  ...
  `harga_tiket` decimal(10,0) DEFAULT 0,
  `harga_porter` decimal(10,0) DEFAULT 0,
  `harga_alat` decimal(10,0) DEFAULT 0,
  `total_harga` decimal(12,0) DEFAULT 0,
...
INSERT INTO `pemesanan` (`pemesanan_id`, `user_id`, `tiket_id`, `tanggal_pesan`, `status`, `kuota_bulanan_berkurang`, `harga_tiket`, `harga_porter`, `harga_alat`, `total_harga`, `durasi`) VALUES
(1, 1, 1, '2025-09-10 10:00:00', 'berhasil', 1, 0, 0, 0, 0, 1),
(22, 11, 2, '2025-12-12 20:52:03', 'berhasil', 1, 25000, 0, 0, 25000, 1),
(23, 11, 8, '2025-12-13 07:45:41', 'berhasil', 1, 35000, 0, 0, 35000, 1);
...
(3, 'Carrier 60L', 30000, 20),
(4, 'Tenda Kapasitas 4 orang', 20000, 5);
...
(3, 2, 'Dimas', 40, 15, '083777777777', 'tersedia', 200000),
(4, 1, 'Nopal Kuat', 1000, 10, '083777777777', 'tersedia', 100000);
...
INSERT INTO `punishment` (`id`, `user_id`, `violation`, `punishment`, `points`, `detail`, `date`) VALUES
(1, 11, 'buang sampah sembarangan', 'push up', 20, '', '2025-12-02 20:09:29');
...
(2, 2, 25000, 78, '2025-09-20 00:00:00'),
(3, 3, 85000, 50, '2025-09-21 00:00:00'),
(4, 1, 35000, 100, '2025-12-14 00:00:00'),
(5, 1, 35000, 100, '2025-12-15 00:00:00'),
(6, 1, 35000, 100, '2025-12-20 00:00:00'),
(7, 1, 35000, 100, '2025-12-21 00:00:00'),
(8, 1, 35000, 100, '2025-12-25 00:00:00'),
(9, 1, 35000, 100, '2025-12-26 00:00:00'),
(10, 1, 35000, 100, '2025-12-27 00:00:00'),
(11, 1, 35000, 100, '2025-12-28 00:00:00'),
(12, 1, 40000, 100, '2026-01-01 00:00:00'),
(13, 1, 40000, 100, '2026-01-04 00:00:00'),
(14, 1, 40000, 100, '2026-01-05 00:00:00'),
(15, 1, 35000, 100, '2026-01-11 00:00:00'),
(16, 1, 35000, 100, '2026-01-12 00:00:00'),
(17, 2, 50000, 80, '2025-12-14 00:00:00'),
(18, 2, 50000, 80, '2025-12-15 00:00:00'),
(19, 2, 50000, 80, '2025-12-20 00:00:00'),
(20, 2, 50000, 80, '2025-12-21 00:00:00'),
(21, 2, 50000, 80, '2025-12-27 00:00:00'),
(22, 2, 50000, 80, '2025-12-28 00:00:00'),
(23, 2, 55000, 80, '2026-01-01 00:00:00'),
(24, 2, 50000, 80, '2026-01-11 00:00:00'),
(25, 2, 50000, 80, '2026-01-12 00:00:00'),
(26, 3, 85000, 50, '2025-12-14 00:00:00'),
(27, 3, 85000, 50, '2025-12-20 00:00:00'),
(28, 3, 85000, 50, '2025-12-21 00:00:00'),
(29, 3, 85000, 50, '2025-12-27 00:00:00'),
(30, 3, 85000, 50, '2026-01-01 00:00:00'),
(31, 3, 85000, 50, '2026-01-11 00:00:00');
...
(18, 'nakulasaputra082@gmail.com', '`123456', 'Nakula Syafa Saputra', '085791686412', '3521101205060001', 'Dusun Sidorejo Rt03/Rw05 Desa Jeblogan Kecamatan Paron', 'user'),
(19, 'nakulasaputra081@gmail.com', '123456', 'naku', '085791686412', '3521101205060001', 'Dusun Sidorejo Rt03/Rw05 Desa Jeblogan Kecamatan Paron', 'user');
...
--
ALTER TABLE `detail_sewa`
  MODIFY `detail_sewa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `jalur_pendakian`
  MODIFY `jalur_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `kuota_bulanan_user`
--
ALTER TABLE `kuota_bulanan_user`
  MODIFY `kuota_bulanan_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pembayaran`
  MODIFY `pembayaran_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `pemesanan`
--
ALTER TABLE `pemesanan`
  MODIFY `pemesanan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `peralatan_sewa`
  MODIFY `peralatan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `porter`
--
ALTER TABLE `porter`
  MODIFY `porter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sewa_porter`
  MODIFY `sewa_porter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `tiket`
--
ALTER TABLE `tiket`
  MODIFY `tiket_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
